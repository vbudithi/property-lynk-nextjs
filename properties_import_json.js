// 🧪 This file was previously used as static sample data for testing (originally named properties_import.json)
// 🔄 The sample data has now been migrated into MongoDB and is no longer used in production
// 📦 Retained for local development, reseeding, and onboarding reference
// 🛠️ If needed, rename back to properties_import.json and use it to seed the database
