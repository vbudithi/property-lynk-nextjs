        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <Link className="flex flex-shrink-0 items-center" href="/">
              <Image className="h-15 w-auto" src={logo} alt="PropertyLynk" />

              <span className="hidden md:block text-2xl font-bold ml-2 bg-gradient-to-r from-orange-400 to-yellow-400 hover:from-yellow-300 hover:to-orange-500 bg-clip-text text-transparent transition-all duration-300 cursor-pointer">
                PropertyLynk
              </span>
            </Link>
            {/* <!-- Desktop Menu Hidden below md screens --> */}
            <div className="hidden md:ml-49 md:flex md:justify-center md:items-center">
              <div className="flex space-x-7">
                <Link
                  href="/"
                  className={`text-white rounded-md px-3 py-2 ${
                    pathname === "/" ? "bg-black" : "hover:bg-gray-600"
                  }`}
                >
                  Home
                </Link>
...
+                border-t border-white/10 shadow-lg hover "
        >
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link
              href="/"
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block w-full rounded-md px-3 py-2 text-white transition-colors
                    ${pathname === "/" ? "bg-black" : ""}`}
            >
              Home
            </Link>
            <Link
              href="/properties"
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block w-full rounded-md px-3 py-2 text-white
